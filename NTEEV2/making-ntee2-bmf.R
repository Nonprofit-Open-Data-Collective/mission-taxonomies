...
#Known used specialty in bmf letter+4digit codes 
codes.special <- read_csv("NTEE-disaggregated/known-speciality-codes-bmf.csv")
...
## Save table
save(ntee.crosswalk, file = "NTEE-disaggregated/ntee-crosswalk-bmf.rda")
write.csv(ntee.crosswalk, file = "NTEE-disaggregated/ntee-crosswalk-bmf.csv", row.names = F)
